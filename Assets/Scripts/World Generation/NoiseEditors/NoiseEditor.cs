...
public static class NoiseEditor
{
    ...
    public static float[,] RemoveSmoothDirX(float[,] _noiseMap, int _dirX, int _sizeDivider, int _mapChunkSize)
    {
    ...
    //edits the noise to dissapear smooth on the X as
    public static float[,] RemoveSmoothDirY(float[,] _noiseMap, int _dirY, int _sizeDivider, int _mapChunkSize)
    {
    ...
    public static bool CheckOverlap(Vector2 _clearPosition, int _clearSize, int _mapChunkSize)
    {
