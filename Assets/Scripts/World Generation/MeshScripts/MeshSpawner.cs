...
public class MeshSpawner : MonoBehaviour
{
    ...
    public void SpawnMesh(MapData _mapData, Texture2D _texture2D, AnimationCurve _heightCurve, ObstacleType[] _obstacleTypes, Vector2 _coord, int _mapChunkSize, bool _generateFromEditor)
    {
        ...
        {
            meshTerrainDictionary.Add(_coord, new MeshTerrain(_mapData.noiseMap, _heightCurve, detailLevels, _texture2D, _coord, parentObject, meshHeightMultiplier, heightOffset, _generateFromEditor));
        }
    ...
    public class MeshTerrain
    {
        ...
        public MeshTerrain(float[,] _noiseMap, AnimationCurve _heightCurve, LODInfo[] _detailLevels, Texture2D _texture2D, Vector2 _coordinates, Transform _parentObject, float _meshHeightMultiplier, float _heightOffsets, bool _inEditorMode)
        {
            noiseMap = _noiseMap;
